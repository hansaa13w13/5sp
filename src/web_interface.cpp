...
// wifi_auth_mode_t: ESP32'de enum, BW16'da platform_compat.h'ta int typedef
...
void handle_root() {
  ...
  html += F("<div class='card'><h2>&#128225; Wi-Fi Aglari</h2><table>"
            "<tr><th>#</th><th>SSID</th><th>BSSID</th><th>Kanal</th><th>Bant</th><th>RSSI</th><th>Sifrelem</th></tr>");
  for (int i = 0; i < num_networks; i++) {
    ...
    html += "<tr><td>" + String(i) + "</td><td><b>" + ssid_disp + "</b></td>"
            ...
            "<td>" + encTag((wifi_auth_mode_t)WiFi.encryptionType(i)) + "</td></tr>";
  }
  html += F("</table><hr>"
